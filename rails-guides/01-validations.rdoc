...
Isto ajudar a validar este seu atributo, a ter somente valores númericos.
Por padrão isto irá corresponder um sinal opcional, seguido de um número
de ponto flutuante ou integrante. Para especificar somente  este numero
integrante, são permitidos set: somente inteiro para verdeiro.
